...
train_volumes, train_masks,y_train, val_volumes, val_masks,y_val, test_volumes, test_masks, y_test = getData(mode = "default", type_ = "volume")
train_x = train_volumes[0:30]
train_masks = train_masks[0:30]
train_y = y_train[0:30]
val_x = val_volumes[0:30]
val_masks = val_masks[0:30]
val_y = y_val[0:30]
test_x = test_volumes[0:30]
test_masks = test_masks[0:30]
test_y = y_test[0:30]
...
train_int_pca = np.concatenate((train_int), axis = 1)

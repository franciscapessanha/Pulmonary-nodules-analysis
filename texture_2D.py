...
def texture_metrics (prediction, val_y):
...
def getTexture(train_x, train_masks, train_y, val_x, val_masks, val_y, test_x, test_masks, test_y):
    ...
    texture_metrics(prediction_all_pca, test_y)
